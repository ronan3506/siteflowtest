...
async function run() {
  ...
  // We will read translations.ts later or just rewrite it
  const existingTranslations = {
    ...
    "continue": { en: "Continue", hi: "जारी रखें", ta: "தொடர்க", te: "కొనసాగించు", kn: "ಮುಂದುವರೆಯಿರಿ", ml: "തുടരുക", bn: "চালিয়ে যান", mr: "पुढे जा", gu: "આગળ વધો", pa: "ਜਾਰੀ ਰੱਖੋ" },
    ...
    "trackProgress": { en: "Track Progress", hi: "प्रगति ट्रैक करें", ta: "முன்னேற்றத்தை கண்காணிக்கவும்", te: "పురోగతిని ట్రాక్ చేయండి", kn: "ಪ್ರಗತಿ ಟ್ರ್ಯಾಕ್ ಮಾಡಿ", ml: "പുരോഗതി ട്രാക്ക് ചെയ്യുക", bn: "অগ্রগতি ট্র্যাক করুন", mr: "प्रगती ट्रॅक करा", gu: "પ્રગતિ ટ્રૅક કરો", pa: "ਤਰੱਕੀ ਟਰੈਕ ਕਰੋ" },
    "tasksUpdatesApprovals": { en: "Tasks, updates, approvals", hi: "कार्य, अपडेट, अनुमोदन", ta: "பணிகள், புதுப்பிப்புகள், ஒப்புதல்கள்", te: "పనులు, నవీకరణలు, ఆమోదాలు", kn: "ಕಾರ್ಯಗಳು, ನವೀಕರಣಗಳು, ಅನುಮೋದನೆಗಳು", ml: "ജോലികൾ, അപ്‌ഡേറ്റുകൾ, അനുമതികൾ", bn: "কাজ, আপডেট, অনুমোদন", mr: "कार्ये, अपडेट, मंजुरी", gu: "કાર્યો, અપડેટ, મંજૂરી", pa: "ਕੰਮ, ਅਪਡੇਟ, ਮਨਜ਼ੂਰੀਆਂ" },
    "everythingInOnePlace": { en: "Everything in one place", hi: "सब कुछ एक जगह", ta: "எல்லாம் ஒரே இடத்தில்", te: "అన్నీ ఒకే చోట", kn: "ಎಲ್ಲವೂ ಒಂದೇ ಸ್ಥಳದಲ್ಲಿ", ml: "എല്ലാം ഒരിടത്ത്", bn: "সবকিছু এক জায়গায়", mr: "सर्वकाही एकाच ठिकाणी", gu: "બધું એક જ જગ્યાએ", pa: "ਸਭ ਕੁਝ ਇੱਕ ਥਾਂ" },
    "getStarted": { en: "Get Started", hi: "शुरू करें", ta: "தொடங்குங்கள்", te: "ప్రారంభించండి", kn: "ಪ್ರಾರಂಭಿಸಿ", ml: "ആരംഭിക്കുക", bn: "শুরু করুন", mr: "सुरू करा", gu: "શરૂ કરો", pa: "ਸ਼ੁਰੂ ਕਰੋ" },
    ...
    "welcomeBack": { en: "Welcome back.", hi: "वापस स्वागत है।", ta: "மீண்டும் வரவேற்கிறோம்.", te: "తిరిగి స్వాగతం.", kn: "ಮತ್ತೆ ಸ್ವಾಗತ.", ml: "തിരിച്ചു സ്വാഗതം.", bn: "ফিরে আসায় স্বাগতম।", mr: "परत स्वागत आहे.", gu: "પાછા સ્વાગત છે.", pa: "ਵਾਪਸ ਸੁਆਗਤ ਹੈ।" },
    "selectProfileToContinue": { en: "Select your profile to continue", hi: "जारी रखने के लिए प्रोफ़ाइल चुनें", ta: "தொடர்வதற்கு உங்கள் சுயவிவரத்தை தேர்ந்தெடுக்கவும்", te: "కొనసాగించడానికి మీ ప్రొఫైల్‌ని ఎంచుకోండి", kn: "ಮುಂದುವರೆಯಲು ನಿಮ್ಮ ಪ್ರೊಫೈಲ್ ಆಯ್ಕೆ ಮಾಡಿ", ml: "തുടരാൻ നിങ്ങളുടെ പ്രൊഫൈൽ തിരഞ്ഞെടുക്കുക", bn: "চালিয়ে যেতে আপনার প্রোফাইল নির্বাচন করুন", mr: "सुरू ठेवण्यासाठी तुमचे प्रोफाइल निवडा", gu: "આગળ વધવા માટે તમારી પ્રોફાઇલ પસંદ કરો", pa: "ਜਾਰੀ ਰੱਖਣ ਲਈ ਆਪਣੀ ਪ੍ਰੋਫਾਈਲ ਚੁਣੋ" },
    "roleArchitect": { en: "ARCHITECT", hi: "वास्तुकार", ta: "கட்டிட வல்லுநர்", te: "ఆర్కిటెక్ట్", kn: "ವಾಸ್ತುಶಿಲ್ಪಿ", ml: "ആർക്കിടെക്റ്റ്", bn: "আর্কিটেক্ট", mr: "वास्तुविशारद", gu: "આર્કિટેક્ટ", pa: "ਆਰਕੀਟੈਕਟ" },
    ...
    "roleClient": { en: "CLIENT", hi: "ग्राहक", ta: "வாடிக்கையாளர்", te: "క్లయింట్", kn: "ಕ್ಲೈಂಟ್", ml: "ക്ലയന്റ്", bn: "ক্লায়েন্ট", mr: "ग्राहक", gu: "ગ્રાહક", pa: "ਗਾਹਕ" },
    ...
    "addProfilePhoto": { en: "Add profile photo", hi: "प्रोफ़ाइल फ़ोटो जोड़ें", ta: "சுயவிவர புகைப்படம் சேர்க்கவும்", te: "ప్రొఫైల్ ఫోటో జోడించండి", kn: "ಪ್ರೊಫೈಲ್ ಫೋಟೋ ಸೇರಿಸಿ", ml: "പ്രൊഫൈൽ ഫോട്ടോ ചേർക്കുക", bn: "প্রোফাইল ফোটো যোগ করুন", mr: "प्रोफाइल फोटो जोडा", gu: "પ્રોફાઇલ ફોટો ઉમેરો", pa: "ਪ੍ਰੋਫਾਈਲ ਫੋਟੋ ਜੋੜੋ" },
    ...
    "assignWork": { "en": "Assign Work", "hi": "काम सौंपें", "ta": "வேலையை ஒதுக்கு", "te": "పనిని కేటాయించండి", "kn": "ಕೆಲಸ ನಿಯೋಜಿಸಿ", "ml": "ജോലി ഏൽപ്പിക്കുക", "bn": "কাজ বরাদ্দ করুন", "mr": "काम सोपवा", "gu": "કામ સોંપો", "pa": "ਕੰਮ ਸੌਂਪੋ" },
    "seeUpdates": { "en": "See updates", "hi": "अपडेट देखें", "ta": "புதுப்பிப்புகளைக் காண்க", "te": "నవీకరణలను చూడండి", "kn": "ನವೀಕರಣಗಳನ್ನು ನೋಡಿ", "ml": "അപ്‌ഡേറ്റുകൾ കാണുക", "bn": "আপডেট দেখুন", "mr": "अपडेट्स पहा", "gu": "અપડેટ્સ જુઓ", "pa": "ਅਪਡੇਟ ਦੇਖੋ" },
    "fixIssuesFast": { "en": "Fix issues fast", "hi": "समस्याओं को तेजी से हल करें", "ta": "சிக்கல்களை விரைவாக சரிசெய்", "te": "సమస్యలను వేగంగా పరిష్కరించండి", "kn": "ಸಮಸ್ಯೆಗಳನ್ನು ವೇಗವಾಗಿ ಪರಿಹರಿಸಿ", "ml": "പ്രശ്നങ്ങൾ വേഗത്തിൽ പരിഹരിക്കുക", "bn": "দ্রুত সমস্যা সমাধান করুন", "mr": "समस्या लवकर सोडवा", "gu": "સમસ્યાઓ ઝડપથી ઉકેલો", "pa": "ਸਮੱਸਿਆਵਾਂ ਜਲਦੀ ਹੱਲ ਕਰੋ" },
    ...
    "submitApprovals": { "en": "Submit Approvals", "hi": "मंज़ूरी सबमिट करें", "ta": "ஒப்புதல்களை சமர்ப்பி", "te": "ఆమోదాలను సమర్పించండి", "kn": "ಅನುಮೋದನೆಗಳನ್ನು ಸಲ್ಲಿಸಿ", "ml": "അംഗീകാരങ്ങൾ സമർപ്പിക്കുക", "bn": "অনুমোদন জমা দিন", "mr": "मंजुरी सबमिट करा", "gu": "મંજૂરી સબમિટ કરો", "pa": "ਮਨਜ਼ੂਰੀਆਂ ਜਮ੍ਹਾਂ ਕਰੋ" }
  };

  // Populate output with existing translations
  ...
  // We have ~390 strings. To translate them fast, we'll join them.
  const delimiter = '\n';
  
  // Filter strings that are not already in existingTranslations
  ...
  for (const s of newStrings) {
    if (currentLength + s.length > 3000) {
  ...
  // To prevent rate limiting, we map English strings to keys.
  const stringToKey = {};
  ...
  for (const chunk of chunks) {
    ...
    for (const [lang, code] of Object.entries(langCodes)) {
      if (lang === 'en') continue;
      try {
        console.log(`Translating chunk for ${lang}...`);
        const res = await translate(textToTranslate, { to: code });
        const translations = res.text.split(delimiter);
        if (translations.length === chunk.length) {
          ...
          console.error(`Mismatch for ${lang}: expected ${chunk.length}, got ${translations.length}`);
          // Fallback: 1 by 1 for this chunk
          for (let i = 0; i < chunk.length; i++) {
             const key = stringToKey[chunk[i]];
             try {
                const tr = await translate(chunk[i], { to: code });
                output[lang][key] = tr.text;
             } catch(e) {
