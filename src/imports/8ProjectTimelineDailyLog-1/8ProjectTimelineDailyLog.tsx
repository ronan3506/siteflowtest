import svgPaths from "./svg-59cqx3vezz";
...
function ProjectTimelineDailyLog() {
  return (
    <div className="absolute drop-shadow-[0px_1px_1px_rgba(0,0,0,0.05)] h-[1194px] left-[11px] top-[40px] w-[390px]" style={{ backgroundImage: "linear-gradient(90deg, rgb(251, 249, 248) 0%, rgb(251, 249, 248) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }} data-name="Project Timeline (Daily Log)">
      <HeaderSection />
      <MainTimelineContent />
      <SectionFilterBar />
    </div>
...
function Group() {
  return (
    <div className="absolute contents left-[11px] top-[40px]">
...
function BottomNavBar() {
  return (
    <div className="absolute bg-[#fbf9f8] border-[#ddc1b4] border-solid border-t h-[64px] left-0 top-[706.17px] w-[390px]" data-name="BottomNavBar">
      <Link />
      <Link1 />
      <Link2 />
      <Link3 />
...
function Frame1() {
  return (
    <div className="absolute h-[738px] left-[11px] top-[441.83px] w-[390px]">
      <Group1 />
    </div>
  );
}
...
export default function Component8ProjectTimelineDailyLog() {
  return (
    <div className="bg-[#fbf9f8] relative size-full" data-name="8. Project Timeline (Daily Log)">
      <Group2 />
      <HeaderTopAppBar />
    </div>
  );
