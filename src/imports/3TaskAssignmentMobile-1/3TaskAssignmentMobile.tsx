...
import imgImage12 from "./c79072b03053f8d4e1dfff5980541de18329d1f1.png";
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <div className="h-[18px] relative shrink-0 w-[11px]" data-name="Icon">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11 18">
            <path d={svgPaths.p34c7c000} fill="var(--fill-0, #7A3100)" id="Icon" />
          </svg>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#564239] text-[10px] uppercase w-full">
        <p className="leading-[15px]">{`Lobby & Entrance`}</p>
      </div>
    </div>
  );
}
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <div className="relative shrink-0 size-[18px]" data-name="Icon">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
            <path d={svgPaths.p9250360} fill="var(--fill-0, #564239)" id="Icon" />
          </svg>
        </div>
      </div>
    </div>
...
function Container10() {
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#564239] text-[10px] uppercase w-full">
        <p className="leading-[15px]">{`kitchen & Living room `}</p>
      </div>
    </div>
  );
}
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <div className="relative shrink-0 size-[20px]" data-name="Icon">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
            <path d={svgPaths.p2e358900} fill="var(--fill-0, #564239)" id="Icon" />
          </svg>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="h-[16px] relative shrink-0 w-[18px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 16">
        <g id="Container">
          <path d={svgPaths.p10002b00} fill="var(--fill-0, #564239)" id="Icon" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="h-[19px] relative shrink-0 w-[16px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 19">
        <g id="Container">
          <path d={svgPaths.p285e6f00} fill="var(--fill-0, #564239)" id="Icon" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="h-[18.025px] relative shrink-0 w-[18.525px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18.525 18.025">
        <g id="Container">
          <path d={svgPaths.p3ce88680} fill="var(--fill-0, #564239)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Background3() {
  ...
  return (
    <div className="bg-[#7a3100] col-1 justify-self-stretch relative rounded-[12px] row-1 self-center shrink-0" data-name="Background">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col gap-[5px] items-center justify-center p-[16px] relative size-full">
          <Container22 />
          <Container23 />
        </div>
      </div>
...
function BackgroundBorder3() {
  ...
  return (
    <div className="bg-white content-stretch flex flex-col items-start justify-center p-[5px] relative rounded-[12px] shrink-0 size-[64px]" data-name="Background+Border">
      <div aria-hidden="true" className="absolute border border-[#7a3100] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="h-[53.551px] relative rounded-[6px] shrink-0 w-[54.112px]" data-name="image 14">
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden pointer-events-none rounded-[6px]">
          <img alt="" className="absolute h-[151.32%] left-0 max-w-none top-[-25.66%] w-full" src={imgImage14} />
        </div>
      </div>
      <Background4 />
    </div>
...
function BackgroundBorder4() {
  ...
  return (
    <div className="content-stretch flex flex-col items-start justify-center opacity-60 p-[5px] relative rounded-[12px] shrink-0 size-[64px]" data-name="Background+Border">
      ...
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0)] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="h-[54.176px] relative rounded-[6px] shrink-0 w-[55px]" data-name="image 13">
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden pointer-events-none rounded-[6px]">
          <img alt="" className="absolute h-[152.28%] left-0 max-w-none top-[-24.58%] w-full" src={imgImage13} />
        </div>
      </div>
    </div>
  );
...
function BackgroundBorder5() {
  ...
  return (
    <div className="content-stretch flex flex-col items-start justify-center opacity-60 p-[5px] relative rounded-[12px] shrink-0 size-[64px]" data-name="Background+Border">
      ...
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0)] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="h-[54.763px] relative rounded-[6px] shrink-0 w-[53.968px]" data-name="image 12">
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden pointer-events-none rounded-[6px]">
          <img alt="" className="absolute h-[163.99%] left-[-17.84%] max-w-none top-0 w-[221.88%]" src={imgImage12} />
        </div>
      </div>
    </div>
  );
...
function BackgroundBorder6() {
  ...
  return (
    <div className="content-stretch flex flex-col items-start justify-center opacity-60 p-[5px] relative rounded-[12px] shrink-0 size-[64px]" data-name="Background+Border">
      ...
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0)] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="h-[53.892px] relative rounded-[6px] shrink-0 w-[54.145px]" data-name="image 15">
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden pointer-events-none rounded-[6px]">
          <img alt="" className="absolute h-[302.85%] left-[-73.82%] max-w-none top-[-39.46%] w-[236.03%]" src={imgImage15} />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[33px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 33 24">
        <g id="Container">
          <path d={svgPaths.p336d2000} fill="var(--fill-0, #8A7267)" id="Icon" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="h-[19px] relative shrink-0 w-[14px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 19">
        <g id="Container">
          <path d={svgPaths.p39e29d00} fill="var(--fill-0, #564239)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Main() {
  ...
  return (
    <div className="absolute content-stretch flex flex-col gap-[30px] h-[1103px] items-start left-0 px-[24px] right-0 top-[70px]" data-name="Main">
      ...
      <Section2SkillSelection />
      <Section3WorkerSelection />
      <Section4DocumentUpload />
      <Section />
    </div>
  );
}
  ...
  return (
    <div className="h-[16px] relative shrink-0 w-[19px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19 16">
        <g id="Container">
          <path d={svgPaths.p28dab5c0} fill="var(--fill-0, white)" id="Icon" />
        </g>
      </svg>
    </div>
  );
