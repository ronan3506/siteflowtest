  ...
  return (
    <div className="absolute bg-[#fdfcfb] border border-[#e6e1dc] border-solid h-[158px] left-0 overflow-clip rounded-[16px] shadow-[0px_0px_4.7px_0px_rgba(0,0,0,0.25)] top-0 w-[342px]" data-name="Card 1">
      ...
      <div className="-translate-y-1/2 absolute flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center leading-[0] left-[23px] text-[#7d6c5c] text-[0px] top-[122px] tracking-[1.1px] w-[110px]">
        ...
        <p className="leading-[17px] text-[10px] text-black">Structural Safety</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center leading-[0] left-[189px] text-[#7d6c5c] text-[0px] top-[122px] tracking-[1.1px] w-[111px]">
        ...
        <p className="leading-[17px] text-[10px] text-black">1h 30m</p>
      </div>
      <Container14 />
    </div>
  );
...
function Card1() {
  return (
    <div className="absolute bg-[#fdfcfb] border border-[#e6e1dc] border-solid h-[158px] left-0 overflow-clip rounded-[16px] shadow-[0px_0px_4.7px_0px_rgba(0,0,0,0.25)] top-[169px] w-[342px]" data-name="Card 2">
      ...
      <div className="-translate-y-1/2 absolute flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center leading-[0] left-[23px] text-[#7d6c5c] text-[0px] top-[122px] tracking-[1.1px] w-[110px]">
        <p className="leading-[17px] mb-0 text-[10px]">Impact</p>
        <p className="leading-[17px] text-[10px] text-black">Water Damage</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center leading-[0] left-[189px] text-[#7d6c5c] text-[0px] top-[122px] tracking-[1.1px] w-[111px]">
        <p className="leading-[17px] mb-0 text-[10px]">Response Due</p>
        <p className="leading-[17px] text-[10px] text-black">4h</p>
      </div>
    </div>
  );
}
...
function Card2() {
  return (
    <div className="absolute bg-[#fdfcfb] border border-[#e6e1dc] border-solid h-[158px] left-0 overflow-clip rounded-[16px] shadow-[0px_0px_4.7px_0px_rgba(0,0,0,0.25)] top-[338px] w-[342px]" data-name="Card 3">
      ...
      <div className="-translate-y-1/2 absolute flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center leading-[0] left-[23px] text-[#7d6c5c] text-[0px] top-[122px] tracking-[1.1px] w-[110px]">
        <p className="leading-[17px] mb-0 text-[10px]">Impact</p>
        <p className="leading-[17px] text-[10px] text-black">Personnel Safety</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center leading-[0] left-[189px] text-[#7d6c5c] text-[0px] top-[122px] tracking-[1.1px] w-[111px]">
        <p className="leading-[17px] mb-0 text-[10px]">Response Due</p>
        <p className="leading-[17px] text-[10px] text-black">30m</p>
      </div>
    </div>
  );
}
